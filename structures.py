...
#  TODO Auto binding functions development
...
class ItemExplorer(Frame):
    ...
    def __init__(self, parent, **options):
        ...
        self.no_content_text = Label(self.no_content, bg="#505050", fg="#1FB27B", font="calibri 15")
        self.no_content_text.pack(side="top")
        self.no_content.place(relx=0.3, rely=0.5, relwidth=0.4, relheight=0.5)
    ...
    def nothing_to_display(self):
        ...
        self.no_content_icon["text"] = "\ue77f"
        self.no_content_text["text"] = "No urls searched yet."
        self.no_content.place(relx=0.3, rely=0.5, relwidth=0.4, relheight=0.5)
    ...
    def start_loader(self):
        self.no_content_text["text"] = "Searching url tree"
        self.clear()
        self.loader.start_load()
...
class PathItem(Frame):
    ...
    def __init__(self, recurse_obj, parent=None, **options):
        super().__init__(parent.body, options)
        self.content_txt = recurse_obj
        self.parent = parent
        self.title_txt = recurse_obj.web_content.title()
        ...
        self.content = Label(body, bg="#404040", fg="#1FB27B", font="calibri 12", text=self.content_txt.web_content.url,
                             anchor="w")
        self.content.pack(side="top", anchor="w", fill="x")
        self.content.bind("<Button-1>", lambda x: self.select())

    def select(self):
        if self.content_txt.depth > self.content_txt.max_depth or not self.content_txt.children:
            return
